  ...
  render() {
      ...
      registed = (
        <div className="align-center">
          <h2 className="text-center mt-2">
            <i className="far fa-check-circle fa-2x text-success" /> Registed, Time to eat !
          </h2>
        </div>
      );
    } else {
    ...
    return (
      <div className="container main-center">
        ...
        <footer className="text-white text-center">Copyright &copy; {new Date().getFullYear()} mMenu</footer>
      </div>
    );
  }
}
